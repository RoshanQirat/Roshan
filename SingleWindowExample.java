...
public static void main(String[] args) {
		...
		//grtwindow mwthod will store the unique session id of opened window
		...
		WebElement button = driver.findElement(By.xpath("//*[@id=\"Tabbed\"]/a/button"));//click inspect, kiya hey...
		button.click();
